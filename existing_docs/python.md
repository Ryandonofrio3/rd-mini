...
<Warning>
  Tracing is currently in beta. We'd love your feedback as we continue to improve the experience. Email: [founders@raindrop.ai](mailto:founders@raindrop.ai)
</Warning>
...
> To find navigation and other pages in this documentation, fetch the llms.txt file at: https://raindrop.ai/docs/llms.txt